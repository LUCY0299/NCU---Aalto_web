        ...
        fetch(
            ...
            .then((res) => {
                ...
                if (sectionKey === "admission-info-and-requirements") {
                    ...
                    const requirementsItems = parseItems(
                        fields.requirements_items
                    )
                    setData({
                        ...fields,
                        infoItems,
...
export default function Information({
    ...
    return (
        ...
        >
            ...
            {/* 招生資訊 - 介紹 + 兩列課程 */}
            {combined.data?.isActive !== false &&
                Array.isArray(combined.data?.infoItems) && (
                    <div
                        style={{
                            padding: "20px",
                            width: "100%",
                    ...
                    >
                        ...
                        >
                            ...
                            {/* 介紹文字 */}
                            {combined.data.infoItems[0] &&
                                combined.data.infoItems[0].is_active !==
                                    false && (
                                    <>
                            ...
                            {/* 兩列課程 */}
                            {combined.data.infoItems[1] &&
                                combined.data.infoItems[1].is_active !==
                                    false && (
                                    <div
                                        style={{
                                            display: "grid",
            ...
            {/* 入學門檻 */}
            {combined.data?.isActive !== false &&
                Array.isArray(combined.data?.requirementsItems) && (
                    <div
                        style={{
                            padding: "20px",
                            width: "100%",
                                ...
                                req.is_active !== false ? (
                                    <div
                                        ...
                                        style={{
                                            marginBottom:
                                                idx <
                                                combined.data.requirementsItems
                                                    .length -
                                                    1
                                                    ? "24px"
                                                    : 0,
                ...
                >
                    ...
                    >
                        {(() => {
                            ...
                            return fileList.map((file: any, idx: number) => {
                                const fileName =
                                    file.title ||
...
addPropertyControls(Information, {
    ...
    locale: {
        ...
        optionTitles: ["Auto Detect", "繁體中文", "English"],
        defaultValue: "auto",
    },
})
